// Resources catalog data + search.
// Pure data and a pure filter function — unit-tested in catalog.test.ts (node env).
// Moved verbatim from page.tsx; do not add JSX here.

export type Link = { name: string; href: string; note: string };

export const certifications: Link[] = [
...
export const dashboardGroups: { label: string; links: Link[] }[] = [
