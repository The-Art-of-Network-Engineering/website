---
title: "Behind the Scenes: How The Art of Network Engineering Podcast is Made"
...
As [Andy Lapteff 🛠️💬](https://www.linkedin.com/in/andylapteff?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAAWhkuoBrY1LzNEa6Ppg4bCALAGUXvNa37c) mentioned on the episode, he wouldn’t have his current role as a senior product marketing manager at a major networking vendor if he didn’t have a body of work that proved he could communicate at a professional level. Technical skills will always matter, but the ability to explain complex concepts clearly is what sets him apart.
...
Bad audio will sink even the most insightful content. That’s why we record on [**Riverside.fm**](http://riverside.fm/), which captures local, high-quality files for each participant. Even if someone’s internet glitches, the final product still sounds crisp.
...
Here’s where podcasting gets real: post-production. Editing used to take three hours per episode. Today, with tools like [TimeBolt.io](https://www.linkedin.com/company/timebolt-io/) (which automatically removes silence), [AutoPod Multi Camera Editor](https://www.autopod.fm/), and [Adobe](https://www.linkedin.com/company/adobe/) [**Enhance Speech**](https://podcast.adobe.com/en/enhance) (which polishes audio), we’ve cut that down to about an hour.

For video, we use [Adobe](https://www.linkedin.com/company/adobe/) [**Premiere Pro**](https://www.adobe.com/products/premiere.html), though free tools like [DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve) work well too. Thumbnails and promo graphics? [Canva](https://www.linkedin.com/company/canva/) all day—it’s simple and fast.
...
We host on [Buzzsprout](https://www.linkedin.com/company/buzzsprout/), which pushes episodes to podcatchers like [Apple](https://www.linkedin.com/company/apple/) Podcasts, [Spotify for Creators](https://www.linkedin.com/company/spotify-for-creators/), and everywhere else you can listen to podcasts.

- **Short clips** via [OpusClip](https://www.linkedin.com/company/opusclip/) for LinkedIn, TikTok, and YouTube Shorts
...
Our co-host [Jeff Clark](https://www.linkedin.com/in/ACoAAAFHfgkBdBu4mW2XPiWbX7uut4mWwnLNCo4?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAAAFHfgkBdBu4mW2XPiWbX7uut4mWwnLNCo4) got his first IT job thanks to a simple YouTube series he made called [*Tech Tip Tuesday*](https://www.youtube.com/@JeffClarksPage/). The production quality? Pretty rough. But the value was there, and that’s what mattered.
...
If you’re curious what goes into the process, or just want a peek at the messy, human side of podcasting, check out this episode of [The Art of Network Engineering](https://www.linkedin.com/company/artofneteng/). We’re pulling back the curtain on how the show is made, the tools that keep us running, and the lessons we’ve learned along the way.

🎧 [Listen to the episode on Apple Podcasts](https://podcasts.apple.com/us/podcast/the-art-of-network-engineering/id1525015389?i=1000719776733)
